...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    // q what happens if we disbale an account mid-flight?
    ...
    // @audit -High If a user approves the bridge, any other user can steal thieir funds
